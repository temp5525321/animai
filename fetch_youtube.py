...
# 페르소나별 키워드 정의
PERSONAS = {
    'meme':        { 'label': '밈파고',          'keywords': ['AI 밈', 'AI 웃긴 영상'] },
    'virtual':     { 'label': '시크릿AI',         'keywords': ['AI 가상인간', '버추얼 인플루언서'] },
    'cinema':      { 'label': '방구석놀란',        'keywords': ['AI 영화', 'AI 단편영화'] },
    'uncanny':     { 'label': '언캐니밸리',        'keywords': ['AI 소름', 'AI 공포'] },
    'cyberpunk':   { 'label': '조선사이버펑크',    'keywords': ['AI 조선', 'AI 한국 역사'] },
    'healing':     { 'label': '픽셀테라피',        'keywords': ['AI 힐링', 'AI 아트'] },
    'music':       { 'label': '그루브생성기',      'keywords': ['AI 음악', 'AI 커버'] },
    'anime':       { 'label': '2D프린터',          'keywords': ['AI 애니', 'AI 일러스트'] },
    'prompt':      { 'label': '프롬프트깎는장인',  'keywords': ['AI 프롬프트', '미드저니 사용법'] },
    'trend':       { 'label': '루어픽',            'keywords': ['AI 영상 2025', '인공지능 트렌드'] },
}

# 제목 키워드로 페르소나 자동 분류
PERSONA_TITLE_KEYWORDS = {
    'meme':      ['밈', '웃긴', '개웃', 'ㅋㅋ', '뇌절', '병맛'],
    'virtual':   ['가상인간', '버추얼', '인플루언서', '룩북', '패션'],
    'cinema':    ['영화', '시네마', '단편', '감독', '촬영'],
    'uncanny':   ['소름', '공포', '무서운', '기괴', '불쾌'],
    'cyberpunk': ['조선', '역사', '한국', '사이버펑크', '대체역사'],
    'healing':   ['힐링', '아트', '그림', '풍경', '로파이', 'lofi'],
    'music':     ['음악', '노래', '커버', '작곡', '비트', '댄스'],
    'anime':     ['애니', '일러스트', '만화', '2D', '캐릭터'],
    'prompt':    ['프롬프트', '사용법', '튜토리얼', '미드저니', '달리', '생성 방법'],
    'trend':     ['트렌드', '최신', '2025', '신기한', '바이럴'],
}
