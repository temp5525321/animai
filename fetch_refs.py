...
TUTORIAL_MARKERS = [
    ...
    '따라하기', '초보', '꿀팁',
    # ★분석 세션 요청(_exchange/from_analyst.md 2026-09-12) — 우리 목록에 빠져 있던 것
    '도구 추천', '툴 추천', '무료 ai', '무료 툴', '추천 툴', '비법', '노하우',
    'free ai', 'best ai tool', 'top ai', 'ai tool', 'which ai',
...
# ⚠️ '이벤트'·'최저가'는 뺐다 — 너무 흔해서 오탐이 났다.
#    「키보드로 만든 걸그룹 뮤비 I Flova AI x seedance 2.5」는 시댄스로 만든
#    진짜 뮤비인데 설명란 스폰서 문구 때문에 탈락했다.
#    협찬이 붙었다고 영상 자체가 무가치한 건 아니다 → 판매가 목적인 문구만 남긴다.
AFFILIATE_MARKERS = [
    '쇼핑 커넥트', '커넥트 활동', '수수료를 제공', '구매가 필요하면', '구매 링크',
    '쿠팡파트너스', '파트너스 활동', 'affiliate link', 'commissions earned',
]
